! SRLOCAT.FOR    Insolation at specified LOCATion    2008/09/22
!
    Implicit Real*8 (A-H,O-Z)
    Parameter (TWOPI=6.283185307179586477d0, EDAYzY=365.2425d0, &
        RSUNd =.267d0, & 
        REFRAC=.583d0)  
    !  RSUNd = mean radius of Sun in degrees
    !  REFRAC = effective Sun disk increase 
...
! Write header information to web page
